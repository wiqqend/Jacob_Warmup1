...
function advanceScene() {
    ...
    if (sceneNumber === 1) {
        ...
        document.getElementById("caption").textContent = " You stand at the entrance to the forest. You can see the light filtering through the trees. Hayden tells you that the One Piece is hidden somewhere in this forest.";
        sceneNumber++;
